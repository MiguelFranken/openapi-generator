...
export function TypeNewsCreationDTOendDate() {
    return Date;
}
export function TypeNewsCreationDTOstartDate() {
    return Date;
}
...
export class NewsCreationDTO { 
    ...
    @Type(TypeNewsCreationDTOendDate)
    ...
    @Type(TypeNewsCreationDTOstartDate)
