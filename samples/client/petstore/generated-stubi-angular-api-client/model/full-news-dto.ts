...
export function TypeFullNewsDTOcreationDate() {
    return Date;
}
export function TypeFullNewsDTOendDate() {
    return Date;
}
export function TypeFullNewsDTOstartDate() {
    return Date;
}

/**
 * Provides full information about a news item
 * <p></p>
 * <p></p>
...
export class FullNewsDTO { 
    ...
    @Type(TypeFullNewsDTOcreationDate)
    
    creationDate: Date;
    /**
     * Whether the news item is temporarily disabled and not visible to users
     * <p>Example: true</p>
     */
