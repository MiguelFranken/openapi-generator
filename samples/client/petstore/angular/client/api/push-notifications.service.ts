...
import { PushNotificationRequestDTO } from '../model/models';
...
/**
 * @property { PushNotificationRequestDTO } request - Used to send/schedule push notifications to/for users
 */
export interface SendPushNotificationRequestParams {
...
/**
  * Endpoints used to send push notifications
...
export class PushNotificationsService {
    ...
    private logger: Logger = new Logger({ name: "PushNotificationsService", flags: ["service"] });
  ...
  * <p></p>
  * @param requestParameters {@link SendPushNotificationRequestParams}
  * @param requestOptions Optional request options
  */

    public sendPushNotification(requestParameters: SendPushNotificationRequestParams, requestOptions?: IRequestOptions): Observable<OkDTO>
    /**
  * Send or schedule a push notification
  * <p></p>
  * <p></p>
  ...
  */
    ...
    public sendPushNotification<T>(requestParameters: SendPushNotificationRequestParams, requestOptions?: IRequestOptionsWithResponseType<T>): Observable<T>
    public sendPushNotification<T>(requestParameters: SendPushNotificationRequestParams, requestOptions?: any): Observable<OkDTO> {
        if (!!requestOptions && !!requestOptions.debugging) {
            ...
            this.logger.debug("Sending request sendPushNotification with parameters", requestParameters);
        }

        const request = requestParameters.request;
        if (request === null || request === undefined) {
            this.logger.error('Required parameter request was null or undefined when calling sendPushNotification.');
            throw new Error('Required parameter request was null or undefined when calling sendPushNotification.');
        }
        ...
        const requestPath = `${this.configuration.basePath}/push`;
        ...
        if (acceptString.includes('image')) {
            ...
            const responseObservable = this.httpClient.post<any>(requestPath ,request,httpOptions).pipe(
