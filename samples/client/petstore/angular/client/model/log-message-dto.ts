...
export class LogMessageDTO { 
    /**
     * Name of the frontend class that logs the message
     * <p>Example: "classname"</p>
     */
    ...
    logname: LogMessageDTO.LognameEnum;
    /**
     * Message body to log
     * <p>Example: "message"</p>
     */
    ...
    message: string;
    /**
     * Some arbitrary timestamp. Usually the moment some event on the frontend side occurred.
     * <p>Example: "timestamp"</p>
     */
...
export namespace LogMessageDTO {
    export type LognameEnum = 'TRACE' | 'DEBUG' | 'WARN' | 'ERROR' | 'INFO';
    export const LognameEnum = {
        TRACE: 'TRACE' as LognameEnum,
        DEBUG: 'DEBUG' as LognameEnum,
        WARN: 'WARN' as LognameEnum,
        ERROR: 'ERROR' as LognameEnum,
        INFO: 'INFO' as LognameEnum
    };
}
