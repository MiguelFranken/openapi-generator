...
export class UserDTO { 
    /**
     * Whether the user already logged into the app the first time by using the provided registration code or nor
     * <p>Example: true</p>
     */
    ...
    activated: boolean;
    /**
     * Whether the user is disabled or not. If the user is disabled he does not have access to the app anymore
     * <p>Example: true</p>
     */
