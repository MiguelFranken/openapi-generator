## @miguelfranken/stubi-backend-angular-client@0.0.1-SNAPSHOT.202004011524
...
```
npm install @miguelfranken/stubi-backend-angular-client@0.0.1-SNAPSHOT.202004011524 --save
```
...
In your project:
```
npm link @miguelfranken/stubi-backend-angular-client
```
